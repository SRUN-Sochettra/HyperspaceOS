...
const FileSystem = (() => {
  ...
  function createDefaultTree() {
    return {
      ...
      "/home/root/Documents": {
        type: "dir",
        children: ["report.md", "budget.txt"],
        created: Date.now(),
      },
      "/home/root/Documents/report.md": {
        type: "file",
        content:
      ...
      "/home/root/Documents/budget.txt": {
        type: "file",
        content:
          "Item              Cost\n──────────────────────\nThree.js          Free\nCodeMirror        Free\nuPlot             Free\nCoffee            $4.50\n──────────────────────\nTotal             $4.50\n",
        size: 180,
      ...
      "/home/root/Projects": {
        type: "dir",
        children: ["hyperspace-os", "experiments"],
        created: Date.now(),
      },
      "/home/root/Projects/hyperspace-os": {
        type: "dir",
        children: ["main.js", "README.md"],
        created: Date.now(),
      },
      "/home/root/Projects/hyperspace-os/main.js": {
        type: "file",
        content:
          "// HyperSpace OS Entry Point\nimport { boot } from './core/OS.js'\n\nboot()\n",
        size: 68,
        created: Date.now(),
        modified: Date.now(),
      },
      "/home/root/Projects/hyperspace-os/README.md": {
        type: "file",
        content:
      ...
      "/home/root/Projects/experiments": {
        type: "dir",
        children: [],
        created: Date.now(),
      },
      ...
      "/home/root/system.log": {
        type: "file",
        content: `[${new Date().toISOString()}] BOOT: System initialized\n[${new Date().toISOString()}] FS: File system mounted\n`,
        size: 100,
        created: Date.now(),
        modified: Date.now(),
      },
  ...
  function mv(from, to) {
    ...
    if (tree[oldParent]?.children) {
      tree[oldParent].children = tree[oldParent].children.filter(
        (c) => c !== oldName,
      );
    }
    if (
      tree[newParent]?.children &&
      !tree[newParent].children.includes(newName)
    ) {
  ...
  function debug() {
    ...
    for (const p of paths) {
      ...
      if (node.type === "dir") {
        console.log(
          `${indent}📁 ${basename(p)}/  (${node.children.length} items)`,
        );
      } else {
