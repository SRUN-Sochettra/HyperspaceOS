...
// App styles
import './apps/contacts/contacts.css'
...
import './apps/files/files.css'
import './apps/calculator/calculator.css'
import './apps/browser/browser.css'
import './apps/settings/settings.css'
import './apps/editor/editor.css'
