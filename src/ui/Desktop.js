...
>>>>>>> origin/main
    ...
    if (items.length === 0) {
      FileSystem.writeFile(
        "/home/root/Desktop/Welcome.md",
        "# Welcome to HyperSpace OS\n\nDouble-click this file to open it in the editor.\n\nTry right-clicking the desktop for more options!\n",
      );
      FileSystem.writeFile(
        "/home/root/Desktop/Notes.md",
        "# Quick Notes\n\nWrite anything here.\n",
      );
    }
        const items = FileSystem.readdir('/home/root/Desktop') || []
  ...
  function render() {
    ...
    container.innerHTML = items
      ...
      <div class="desktop-icon" 
        ...
        <div class="desktop-icon-label">${escapeHtml(item.name)}</div>
      </div>
    `,
      )
      .join("");
    ...
    const items = [
      {
        ...
        action: () => {
          ...
          if (name)
            FileSystem.writeFile(
              FileSystem.join("/home/root/Desktop", name),
              "",
            );
        },
      },
      {
        ...
        action: () => {
          const name = prompt("Folder name:");
          if (name)
            FileSystem.mkdir(FileSystem.join("/home/root/Desktop", name));
        },
      },
      { type: "separator" },
      {
