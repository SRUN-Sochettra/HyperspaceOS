...
const Spotlight = (() => {
  ...
  function renderResults() {
    ...
    // Click handlers
    results
      .querySelectorAll(".spotlight-result:not(.disabled)")
      .forEach((el) => {
